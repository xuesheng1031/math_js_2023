...
def get_shortest_time(structure: list):
    # structure_list是结构
    ...
    return solution_list[0].end_time, solution_list[0].state



def main():
    # 初始化结构种群
    for epoch in range(population_num):
        pass
        # 进化
        # 每个个体计算最短加工时间 get_shortest_time(structure)
        # 选择
        # 交叉
        # 变异
        # 重复
